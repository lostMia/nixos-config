{
  ...
  services.udev.extraRules = ''
    ...
    # ACTION=="change", DEVPATH=="/devices/pci0000:00/0000:00:14.3/ACPI0003:00/power_supply/ACAD", SUBSYSTEM=="power_supply", ENV{POWER_SUPPLY_NAME}=="ACAD", ENV{POWER_SUPPLY_TYPE}=="Mains", ENV{POWER_SUPPLY_ONLINE}=="0", RUN+="/home/mia/Scripts/change_charging_state.sh 0"
    # ACTION=="change", DEVPATH=="/devices/pci0000:00/0000:00:14.3/ACPI0003:00/power_supply/ACAD", SUBSYSTEM=="power_supply", ENV{POWER_SUPPLY_NAME}=="ACAD", ENV{POWER_SUPPLY_TYPE}=="Mains", ENV{POWER_SUPPLY_ONLINE}=="1", RUN+="/home/mia/Scripts/change_charging_state.sh 1"
